namespace ProgramService.Auth;

/// <summary>
/// The authenticated caller, derived from the trusted headers the Gateway injects after
/// validating the JWT (architecture-guide §7). This service never parses JWTs itself.
/// Header names are duplicated here (not shared) per §12.
/// </summary>
